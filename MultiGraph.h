...
{
    float w0, w1;
    EdgeResult(float first, float second)
    {
        w0 = first;
        w1 = second;
    }
...
public:
    EdgeResult FindEdge(const std::string &edgeName,
                        const std::string &vertexFromName,
                        const std::string &vertexToName);
    VertexResult FindVertex(const std::string &vertexFromName,
