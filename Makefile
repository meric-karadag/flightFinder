...
# Executables
TC_CENGFlight: mainFlight.o MultiGraph.o FlightFinder.o
	$(CC) $(LFLAGS) mainFlight.o MultiGraph.o FlightFinder.o -o TC_CENGFlight
...
FlightFinder.o: FlightFinder.cpp FlightFinder.h $(HASH_T_FILES) MultiGraph.h
	$(CC) $(CFLAGS) -o FlightFinder.o FlightFinder.cpp
